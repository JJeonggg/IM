...
public class AddFaceClass extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.addface_activity);
        ...
        BtnCheck.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent intent = new Intent(AddFaceClass.this, FaceActivity.class);
    ...
    {
        Toast.makeText(AddFaceClass.this, "올바른 버튼을 눌러주세요.", Toast.LENGTH_SHORT).show();
    }
}
