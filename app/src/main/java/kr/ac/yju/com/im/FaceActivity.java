...
public class FaceActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.face_join);
        ...
        BtnLogin.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                dialog = ProgressDialog.show(FaceActivity.this, "",
        ...
        BtnBirth.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                DatePickerDialog dialog = new DatePickerDialog(FaceActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        try {
            ...
            if (response.equalsIgnoreCase("User Found"))
            {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(FaceActivity.this, "아이디가 존재 합니다.", Toast.LENGTH_SHORT).show();
                    }
                });
            ...
            else
            {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(FaceActivity.this, "사용 가능한 아이디 입니다.", Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        try {
            ...
            if (response.equalsIgnoreCase("User Found"))
            {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(FaceActivity.this, "닉네임이 존재 합니다." , Toast.LENGTH_SHORT).show();
            ...
            else
            {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(FaceActivity.this, "사용 가능한 닉네임 입니다.", Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    public void insert(View view)
    {
        if(memberNumber == "1")
        {
            ...
            intent = new Intent(FaceActivity.this, FacelicenseeActivity.class);
        ...
        if(memberNumber == "0") // memberNumber == 0 이면 바로 회원 가입.
        {
            ...
            insertoToDatabase(Id, Pw, Cl, Name, Tel, Add, Birth, Nick,Fid);
    ...
    private void insertoToDatabase(String Id, String Pw, String Cl, String Name, String Tel, String Add, String Birth, String Nick, String Fid)
    {
        class InsertData extends AsyncTask<String, Void, String>
        {
            ...
            {
                super.onPreExecute();
                loading = ProgressDialog.show(FaceActivity.this, "Please Wait", null, true, true);
            }
            @Override
            ...
            protected String doInBackground(String... params)
            {
                ...
                try
                {
                    ...
                    String Fid = (String) params[8];

                    String link = "http://101.101.162.32/FaceJoin.php";
        ...
        task.execute(Id, Pw,Cl, Name, Tel, Add, Birth,Nick,Fid);
    }
        ...
        popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId())
                {
                    case R.id.normal:
                        memberNumber = "0";
                        Toast.makeText(FaceActivity.this, "일반 회원 선택" , Toast.LENGTH_SHORT).show();
                    ...
                    case R.id.licensee:
                        memberNumber = "1";
                        Toast.makeText(FaceActivity.this, "사업자 선택" , Toast.LENGTH_SHORT).show();
    ...
    {
        Toast.makeText(FaceActivity.this, "올바른 버튼을 눌러주세요.", Toast.LENGTH_SHORT).show();
    }
