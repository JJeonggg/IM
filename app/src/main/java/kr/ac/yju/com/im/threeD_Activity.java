...
public class threeD_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_three_d_);
        ...
        mWebView = (WebView)findViewById(R.id.webview_3d);
        ...
        //mWebView.loadUrl("http://101.101.162.32:8080/unity/test.jsp");
        //mWebView.loadUrl("http://101.101.162.32:8080/unity/index.html");
        mWebView.postUrl("http://101.101.162.32:8080/unity/test.jsp", EncodingUtils.getBytes(postData, "BASE64"));
        setupFullscreenMode();
        setFullscreen();
    }
    ...
    public void onBackPressed() {
        android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(threeD_Activity.this);
        builder.setMessage("메인화면으로 돌아가시겠습니까?");
        builder.setCancelable(false)
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int i) {
                        Intent intent = new Intent(threeD_Activity.this, MainActivity.class);
