...
public class KakaoActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        Knickname = intent.getStringExtra("Knickname");
        Kid = intent.getStringExtra("Kid");


        editTextName.setText(Kname);
        editTextId.setText(Kid);
        editTextNick.setText(Knickname);

        Toast.makeText(KakaoActivity.this, Kid, Toast.LENGTH_SHORT).show();
        ...
        BtnADD.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                Intent intent = new Intent(KakaoActivity.this, AddNaverClass.class);
        ...
        BtnCheckNick.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                dialog = ProgressDialog.show(KakaoActivity.this, "",
        ...
        BtnBirth.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                DatePickerDialog dialog = new DatePickerDialog(KakaoActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        try {
            ...
            if (response.equalsIgnoreCase("User Found"))
            {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(KakaoActivity.this, "아이디가 존재 합니다.", Toast.LENGTH_SHORT).show();
                    }
                });
            ...
            else
            {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(KakaoActivity.this, "사용 가능한 아이디 입니다.", Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        try {
            ...
            if (response.equalsIgnoreCase("User Found"))
            {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(KakaoActivity.this, "닉네임이 존재 합니다." , Toast.LENGTH_SHORT).show();
            ...
            else
            {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(KakaoActivity.this, "사용 가능한 닉네임 입니다.", Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    public void insert(View view)
    {
        if(memberNumber == "1")
        {
            ...
            intent = new Intent(KakaoActivity.this, KakaolicenseeActivity.class);
            intent.putExtra( "Id", Id);
            intent.putExtra( "Pw", Pw);
            intent.putExtra( "Cl", Cl);
            intent.putExtra( "Name", Name);
        ...
        if(memberNumber == "0") // memberNumber == 0 이면 바로 회원 가입.
        {
            ...
            insertoToDatabase(Id, Pw, Cl, Name, Tel, Add, Birth, Nick,Kid);
    ...
    private void insertoToDatabase(String Id, String Pw, String Cl, String Name, String Tel, String Add, String Birth, String Nick, String Kid)
    {
        class InsertData extends AsyncTask<String, Void, String>
        {
            ...
            {
                super.onPreExecute();
                loading = ProgressDialog.show(KakaoActivity.this, "Please Wait", null, true, true);
            }
            @Override
            ...
            protected String doInBackground(String... params)
            {
                ...
                try
                {
                    ...
                    String Kid = (String) params[8];

                    String link = "http://101.101.162.32/KakaoJoin.php";
        ...
        task.execute(Id, Pw,Cl, Name, Tel, Add, Birth,Nick,Kid);
    }
        ...
        popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId())
                {
                    case R.id.normal:
                        memberNumber = "0";
                        Toast.makeText(KakaoActivity.this, "일반 회원 선택" , Toast.LENGTH_SHORT).show();
                    ...
                    case R.id.licensee:
                        memberNumber = "1";
                        Toast.makeText(KakaoActivity.this, "사업자 선택" , Toast.LENGTH_SHORT).show();
    ...
    {
        Toast.makeText(KakaoActivity.this, "올바른 버튼을 눌러주세요.", Toast.LENGTH_SHORT).show();
    }
}
