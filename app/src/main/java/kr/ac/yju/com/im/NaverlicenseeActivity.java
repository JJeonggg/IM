...
public class NaverlicenseeActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.naverlicensee_activity);
    ...
    public void onclickliCheck(View view)
    {
        ...
        insertoToDatabase(Id, Pw, Cl, Name, Tel, Add, Birth, Nick, Com,Nid);

        startActivity(new Intent(this, loginActivity.class));
        finish();
    }

    private void insertoToDatabase(String Id, String Pw, String Cl, String Name, String Tel, String Add, String Birth, String Nick, String Com, String Nid)
    {
        class InsertData extends AsyncTask<String, Void, String>
        {
            ...
            {
                super.onPreExecute();
                loading = ProgressDialog.show(NaverlicenseeActivity.this, "Please Wait", null, true, true);
            }
            @Override
            ...
            protected String doInBackground(String... params)
            {
                ...
                try
                {
                    ...
                    String Nid = (String) params[9];

                    String link = "http://101.101.162.32/Naverlice.php";
        ...
        task.execute(Id, Pw,Cl, Name, Tel, Add, Birth,Nick,Com,Nid);
    }
    ...
    {
        Toast.makeText(NaverlicenseeActivity.this, "올바른 버튼을 눌러주세요.", Toast.LENGTH_SHORT).show();
    }
}