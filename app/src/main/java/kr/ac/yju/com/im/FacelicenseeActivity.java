...
public class FacelicenseeActivity extends AppCompatActivity {
    private EditText editTextCom;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.facelicense_activity);
    ...
    public void onclickliCheck(View view) {
        ...
        insertoToDatabase(Id, Pw, Cl, Name, Tel, Add, Birth, Nick, Com, Fid);

        startActivity(new Intent(this, loginActivity.class));
        finish();
    }

    private void insertoToDatabase(String Id, String Pw, String Cl, String Name, String Tel, String Add, String Birth, String Nick, String Com, String Fid) {
        class InsertData extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(FacelicenseeActivity.this, "Please Wait", null, true, true);
            }
            ...
            protected String doInBackground(String... params) {
                ...
                try {
                    ...
                    String Fid = (String) params[9];

                    String link = "http://101.101.162.32/Facelice.php";
        ...
        task.execute(Id, Pw, Cl, Name, Tel, Add, Birth, Nick, Com, Fid);
    }
    ...
    {
        Toast.makeText(FacelicenseeActivity.this, "올바른 버튼을 눌러주세요.", Toast.LENGTH_SHORT).show();
    }
}