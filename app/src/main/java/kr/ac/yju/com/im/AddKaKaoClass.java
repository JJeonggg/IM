...
public class AddKaKaoClass extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.addkakao_activity);
        ...
        BtnCheck.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent intent = new Intent(AddKaKaoClass.this, FaceActivity.class);
    ...
    {
        Toast.makeText(AddKaKaoClass.this, "올바른 버튼을 눌러주세요.", Toast.LENGTH_SHORT).show();
    }
}
